...
def blend(img_target, img_source, img_mask, offset=(0, 0)):
    ...
    for num_layer in range(img_target.shape[2]):
        ...
        # solve Ax = b
        x = pyamg.solve(A,b,verb=False,tol=3e-10)
...
def test():
    img_mask = np.asarray(PIL.Image.open('./FG_DB/inst_0_6663.pbm'))
    img_mask.flags.writeable = True
    img_source = np.asarray(PIL.Image.open('./FG_DB/inst_0_6663.jpg'))
    img_source.flags.writeable = True
    img_target = np.asarray(PIL.Image.open('./DS/image_2/000000_10.png'))
